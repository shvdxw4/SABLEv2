...
export default function CreatorLogin() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            setError(err.message || "Creator login failed");
        } finally {
            setLoading(false);
        }
    }
    ...
    return (
        <div className="mx-auto max-w-md">
            <div className="mb-8">
                <h1 className="text-3xl font-semibold tracking-tight">Artist Login</h1>
            ...
            <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm dark:border-sable-border dark:bg-sable-panel dark:shadow-soft">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                        {loading ? "Signing in…" : "Artist Login"}
                    </button>
                </form>
                ...
                <div className="mt-6">
                    ...
                    >
                        Need an artist account? Sign up
                    </Link>
                </div>
            </div>
        </div>
